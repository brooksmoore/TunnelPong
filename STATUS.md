...
**Last updated:** 2026-08-04 (Claude) — v1.8 depth dot + HUD type on tunnel surfaces, 29 assertions green, installed on device.
...
|-------|--------|
| Name | **CyberPong** |
| Version | **v1.8** (surface HUD type; depth dot; centre start; curve + scoring; endless solo chase) |
